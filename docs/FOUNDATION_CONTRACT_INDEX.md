...
| `docs/CASE_DELETE_RETENTION_SMOKE_CHECKPOINT.md` | Delete / Retention smoke checkpoint recording 30-day unpaid active case and 60-day pending checkout retention test results. |
