    ...
    <Card className="overflow-hidden">
      <div className="p-8 md:p-10">
        ...
        <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-800">
          You are starting a small pilot based on your diagnostic result. This
          page helps you test one structural improvement in one real workflow.
        </p>
...
function WorkflowPicker({ selectedWorkflow, onSelect, customWorkflow, onCustomChange }) {
  ...
  return (
    <Card className="p-6 md:p-7">
      <SectionTitle
        title="Choose one workflow to test first"
        hint="Do not pilot the whole system. Pick one recurring workflow where improvement will be visible."
      />
  ...
  return (
    <Card className="p-6 md:p-7">
      ...
      <div className="mt-4 rounded-2xl border border-amber-200 bg-amber-50 p-4">
        ...
        <p className="mt-2 text-sm leading-6 text-amber-900">{success}</p>
      </div>
    </Card>
  );
}
...
function CarryOverSection({ preview }) {
  ...
  return (
    <Card className="p-6 md:p-7">
      <SectionTitle
        title="What this pilot is based on"
        hint="This pilot inherits the strongest signals from your result page, so you are not starting from scratch."
      />
