...
const requiredDocs = [
  ...
  'docs/NIMCLEA_V0_9_4H_PRODUCTION_CASES_LOOKUP_CONTRACT_INSPECTION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_4I_CASES_RUNTIME_LOOKUP_PATH_ALIGNMENT_INSPECTION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_4J_CASES_RUNTIME_LOOKUP_PATH_ALIGNMENT_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_4K_CASES_RUNTIME_LOOKUP_PATH_ALIGNMENT_IMPLEMENTATION_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_4L_CASES_EMAIL_LOOKUP_SCHEMA_CONTRACT_DRIFT_BLOCKER_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_4M_EMAIL_TO_CASE_AUTHORITY_CONTRACT_DIRECTION_DECISION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_4N_EMAIL_TO_CASE_AUTHORITY_IMPLEMENTATION_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_4O_EMAIL_TO_CASE_AUTHORITY_IMPLEMENTATION_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_4P_CASES_EMAIL_LOOKUP_DEPLOYED_DETERMINISTIC_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_4Q_DEPLOYED_AUTHORITY_AVAILABILITY_INSPECTION_RECORD_V0_1.md',
  ...
  'docs/NIMCLEA_V0_9_4V_DEPLOYED_AUTHORITY_PROBE_ENABLEMENT_ROUTE_AVAILABILITY_RESOLUTION_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_4W_DEPLOYED_PROTECTED_AUTHORITY_PROBE_ENABLEMENT_EXECUTION_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_4X_ROUTE_REGISTRATION_DEPLOYED_INCLUSION_INSPECTION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_4Y_RENDER_REHEARSAL_ENV_ACTIVATION_VERIFICATION_PROTECTED_PROBE_RESMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_4Z_DEPLOYED_AUTHORITY_PROBE_PASS_CLOSURE_NEXT_SCOPE_DECISION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5A_DEPLOYED_AUTHORITY_READ_PATH_CONFIDENCE_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5B_DEPLOYED_AUTHORITY_READ_PATH_CONFIDENCE_INSPECTION_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5C_DEPLOYED_AUTHORITY_READ_PATH_CONFIDENCE_BLOCKER_CLASSIFICATION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5D_DEPLOYED_SUPABASE_AUTHORITY_TARGET_SCHEMA_FIXTURE_AVAILABILITY_INSPECTION_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5E_DEPLOYED_SUPABASE_AUTHORITY_TARGET_SCHEMA_FIXTURE_AVAILABILITY_INSPECTION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5F_DEPLOYED_RUNTIME_SUPABASE_ENV_PARITY_EFFECTIVE_ACCESS_BLOCKER_CLASSIFICATION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5G_DEPLOYED_SUPABASE_ENV_PARITY_VERIFICATION_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5H_DEPLOYED_SUPABASE_ENV_PARITY_VERIFICATION_EXECUTION_PROTECTED_PROBE_RESMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5I_DEPLOYED_SUPABASE_ENV_PARITY_PASS_CLOSURE_NEXT_SCOPE_DECISION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5J_DEPLOYED_CASES_EMAIL_ENDPOINT_CONFIDENCE_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5K_DEPLOYED_CASES_EMAIL_ENDPOINT_CONFIDENCE_INSPECTION_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5L_CASES_EMAIL_EMPTY_RESPONSE_BLOCKER_ROUTE_PATH_INSPECTION_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5M_CASES_EMAIL_EMPTY_RESPONSE_ROUTE_PATH_INSPECTION_EXECUTION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5N_CASES_EMAIL_CLEAN_AUTHORITY_HELPER_ALIGNMENT_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5O_CASES_EMAIL_CLEAN_AUTHORITY_HELPER_ALIGNMENT_IMPLEMENTATION_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5P_CASES_EMAIL_ENDPOINT_DEPLOYED_FIXTURE_CONFIDENCE_RESMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5Q_DEPLOYED_RUNTIME_REFLECTION_PUBLIC_ROUTE_INCLUSION_INSPECTION_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5R_DEPLOYED_RUNTIME_REFLECTION_PUBLIC_ROUTE_INCLUSION_INSPECTION_EXECUTION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5S_CASES_EMAIL_FINAL_ASSEMBLY_DURABLE_CANDIDATE_PROMOTION_INSPECTION_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5T_CASES_EMAIL_FINAL_ASSEMBLY_DURABLE_CANDIDATE_PROMOTION_INSPECTION_EXECUTION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5U_CASES_EMAIL_CLEAN_AUTHORITY_FINAL_ASSEMBLY_PROMOTION_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5V_CASES_EMAIL_CLEAN_AUTHORITY_FINAL_ASSEMBLY_PROMOTION_IMPLEMENTATION_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5W_CASES_EMAIL_ENDPOINT_DEPLOYED_FIXTURE_CONFIDENCE_RESMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5X_CASES_EMAIL_POST_5V_RUNTIME_REFLECTION_FINAL_ASSEMBLY_OBSERVABILITY_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5Y_CASES_EMAIL_FINAL_ASSEMBLY_OBSERVABILITY_IMPLEMENTATION_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5Y_A_CASES_EMAIL_FINAL_ASSEMBLY_OBSERVABILITY_ROUTE_IMPLEMENTATION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5Z_CASES_EMAIL_FINAL_ASSEMBLY_EMISSION_BLOCKER_CLASSIFICATION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AA_CASES_EMAIL_FINAL_ASSEMBLY_EMISSION_IMPLEMENTATION_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AB_CASES_EMAIL_FINAL_ASSEMBLY_EMISSION_IMPLEMENTATION_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AC_CASES_EMAIL_FINAL_ASSEMBLY_EMISSION_CLOSURE_SCOPE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AD_CASE_DETAIL_ENDPOINT_DEPLOYED_READ_PATH_CONFIDENCE_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AE_CASE_DETAIL_ENDPOINT_DEPLOYED_READ_PATH_CONFIDENCE_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AF_CASE_DETAIL_ENDPOINT_DEPLOYED_READ_PATH_CLOSURE_SCOPE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AG_RECEIPT_AUTHORITY_READ_PATH_CONFIDENCE_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AH_RECEIPT_AUTHORITY_READ_PATH_INSPECTION_SMOKE_TARGET_SELECTION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AI_RECEIPT_AUTHORITY_FIXTURE_AVAILABILITY_HELPER_ALIGNMENT_INSPECTION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AJ_RECEIPT_READ_HELPER_CANONICAL_ALIGNMENT_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AK_RECEIPT_READ_HELPER_CANONICAL_ALIGNMENT_IMPLEMENTATION_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AL_RECEIPT_READ_HELPER_CANONICAL_ALIGNMENT_CLOSURE_SCOPE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AM_RECEIPT_AUTHORITY_DEPLOYED_READ_PATH_CONFIDENCE_CANDIDATE_TARGET_SELECTION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AN_RECEIPT_AUTHORITY_DEPLOYED_READ_PATH_CONFIDENCE_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AO_RECEIPT_DEPLOYED_READ_PATH_BLOCKER_CLASSIFICATION_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AP_RECEIPT_DEPLOYED_READ_PATH_ROUTE_SURFACE_IMPLEMENTATION_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AQ_RECEIPT_DEPLOYED_READ_PATH_ROUTE_SURFACE_IMPLEMENTATION_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_5AR_RECEIPT_DEPLOYED_READ_PATH_ROUTE_SURFACE_CLOSURE_SCOPE_RECORD_V0_1.md',
  ...
  'docs/NIMCLEA_LR1_CONTROLLED_LAUNCH_READINESS_SCOPE_CLAIM_BOUNDARY_RECORD_V0_1.md',
  'docs/NIMCLEA_LR2_PAYMENT_MINIMUM_VIABLE_PATH_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_LR3_RECEIPT_PAID_UNLOCK_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_V0_9_AUTO2_CODEX_FILL_PIPELINE_SCRIPT_RECORD_V0_1.md',
  'docs/NIMCLEA_LR4_PDF_EXPORT_PAID_GATE_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_LR5_PDF_EXPORT_PAID_GATE_IMPLEMENTATION_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_LR5A_PDF_EXPORT_PAID_GATE_CLOSURE_SCOPE_RECORD_V0_1.md',
  ...
  'docs/NIMCLEA_AUTO3A_SELF_HEAL_CURRENT_STATE_JUDGMENT_CANDIDATE_RECORD_V0_1.md',
  ...
  'docs/NIMCLEA_LR10_STORAGE_AND_PDF_RETENTION_DECISION_RECORD_V0_1.md',
  'docs/NIMCLEA_LR11_CONTROLLED_END_TO_END_GOLDEN_CUSTOMER_SMOKE_RECORD_V0_1.md',
  'docs/NIMCLEA_AUTO2B_TOKEN_EFFICIENT_THREE_MODE_CANDIDATE_RECORD_V0_1.md',
  'docs/NIMCLEA_AUTO2B_MODE_B_TERMINAL_PATCH_IMPLEMENTATION_RECORD_V0_1.md',
  'docs/NIMCLEA_LR12_CONTROLLED_LAUNCH_READINESS_CLOSURE_SCOPE_RECORD_V0_1.md',
  'docs/NIMCLEA_LR13_FIRST_CUSTOMER_LAUNCH_RUNBOOK_OUTREACH_READINESS_RECORD_V0_1.md',
  'docs/NIMCLEA_LR14_FIRST_CUSTOMER_OUTREACH_MESSAGE_CONTROLLED_INTAKE_PACKAGE_RECORD_V0_1.md',
